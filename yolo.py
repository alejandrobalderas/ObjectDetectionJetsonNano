...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font='utils/font/FiraMono-Medium.otf',
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            final_detection = left, top, right, bottom, predicted_class, score
        ...
        print("Inference time: "+str(forwardpass_timer-preprocessing_timer))

        inference_time = end-start
        return image, final_detections, inference_time
...
def detect_video(yolo, video_path, output_path=""):
    ...
    while True:
        ...
        image, bbox = yolo.detect_image(image)
